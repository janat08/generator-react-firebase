...
firebase.initializeApp({
  ...
  messagingSenderId: !STAGE_MESSAGING_ID || self.location.hostname.includes('dsf') // eslint-disable-line no-undef
    ? PROD_MESSAGING_ID
    : STAGE_MESSAGING_ID
})
/* eslint-disable prettier/prettier */
...
messaging.setBackgroundMessageHandler(function (payload) {
  ...
  const notificationTitle = 'Firebase2'
